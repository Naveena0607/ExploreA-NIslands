...
public class cafe extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cardA.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(cafe.this,fullmooncafe.class);
                startActivity(i);
                finish();
            }
        });
        ...
        cardB.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(cafe.this,fatmartincafe.class);
                startActivity(i);
                finish();
            }
        });
        ...
        cardC.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(cafe.this,somethingdiff.class);
                startActivity(i);
                finish();
            }
        });
        ...
        cardD.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(cafe.this,keralacafe.class);
                startActivity(i);
                finish();
            }
        });
        ...
        cardE.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(cafe.this,brewcafe.class);
                startActivity(i);
                finish();
            }
        });
        ...
        cardF.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(cafe.this,caferebel.class);
                startActivity(i);
                finish();
            }
        });
        ...
        cardG.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(cafe.this,nemocafe.class);
                startActivity(i);
                finish();
            }
        });
        ...
        cardH.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(cafe.this,bluebetel.class);
                startActivity(i);
                finish();
            }
        });
        ...
        cardI.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(cafe.this,cafekookie.class);
                startActivity(i);
                finish();
            }
        });
        ...
        cardJ.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(cafe.this,cafdelmer.class);
                startActivity(i);
                finish();
            }
        });
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        if (item.getItemId() == android.R.id.home) {
            Intent i = new Intent(cafe.this,InsightActivity.class);
            startActivity(i);
            finish();
        }
