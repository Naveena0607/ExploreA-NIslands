...
public class fairsnfaesti extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fairsnfaesti);
        ...
        cardA.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(fairsnfaesti.this,kalipooja.class);
                startActivity(i);
                finish();
            }
        });
        ...
        cardB.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(fairsnfaesti.this,istouristfesti.class);
                startActivity(i);
                finish();
            }
        });
        ...
        cardC.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(fairsnfaesti.this,durgapooja.class);
                startActivity(i);
                finish();
            }
        });
        ...
        cardD.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(fairsnfaesti.this,deepavali.class);
                startActivity(i);
                finish();
            }
        });
        ...
        cardE.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(fairsnfaesti.this,shivaratri.class);
                startActivity(i);
                finish();
            }
        });
        ...
        cardF.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(fairsnfaesti.this,ganeshpooja.class);
                startActivity(i);
                finish();
            }
        });
        ...
        cardG.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(fairsnfaesti.this,gurunanak.class);
                startActivity(i);
                finish();
            }
        });
        ...
        cardH.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(fairsnfaesti.this,holi.class);
                startActivity(i);
                finish();
            }
        });
        ...
        cardI.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(fairsnfaesti.this,christmas.class);
                startActivity(i);
                finish();
            }
        });
        ...
        cardJ.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(fairsnfaesti.this,ramzan.class);
                startActivity(i);
                finish();
            }
        });
        ...
        cardK.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(fairsnfaesti.this,eid.class);
                startActivity(i);
                finish();
            }
        });
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        if (item.getItemId() == android.R.id.home) {
            Intent i = new Intent(fairsnfaesti.this,InsightActivity.class);
            startActivity(i);
            finish();
        }
